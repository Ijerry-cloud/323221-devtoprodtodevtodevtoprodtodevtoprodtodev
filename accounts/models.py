...
class User(AbstractUser):
    ...
    USER_DEPTS = (
        ("tech", "Technology"),
        ("cust_exp", "Customer Experience User"),
        ("risk_man", "Risk Management User"),
    )
    ...
    dept = models.CharField(
        _("user dept"), max_length=50, choices=USER_DEPTS, default="tech", blank=True
    )
    gender = models.CharField(
        max_length=50, choices=USER_GENDER, default="male", blank=True
    )
